        ...
        if (!me.tpl) {
            me.tpl = new Ext.XTemplate(
                      ...
                      '<li role="option" class="' + me.itemCls + '">'
                              ...
                              + '&nbsp&nbsp&nbsp&nbsp' + me.getInnerTpl(me.displayField) 
                               +'</li>',
                      '</tpl></ul>');
...
Ext.define('Ext.ux.form.MultiSelect', {
    ...
    requires: ['Ext.panel.Panel', 'Ext.view.BoundList', 'Ext.layout.container.Fit', 'Ext.view.MultiSelectDisplayValue'],
